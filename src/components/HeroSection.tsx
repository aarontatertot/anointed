...
const slides = [
  { url: '/images/studio/barber-chairs-wide.jpg', alt: 'ANOINTED collection' },
  { url: '/images/studio/portrait-street.jpg', alt: 'ANOINTED collection' },
  { url: '/images/studio/barber-chair-single.jpg', alt: 'ANOINTED collection' },
]
